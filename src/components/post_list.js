...
const PostList = () => {
    ...
    const getData = () => {
        blogList(10, 0, title, content, status).then(res => res.json()).then(res => {
            if (res.status === 200)
                ...
                <div className="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    ...
                    <div className="header-elements d-none">
                        <div className="breadcrumb justify-content-center">
                            <a href="/post_add" className="breadcrumb-elements-item">
                        ...
                        <div className="card">
                            <div className="card-header bg-dark">
                                <h6 className="card-title">
                                    <a data-toggle="collapse" className="collapsed text-white" href="#collapsible-search-items">Post filter<span className="text-grey-300"> (You can filter the posts)</span> </a>
                                </h6>
                            </div>
